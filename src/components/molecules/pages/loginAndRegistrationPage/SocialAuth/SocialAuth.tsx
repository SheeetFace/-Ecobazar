...
const SocialAuth:React.FC = () => {
    ...
    const auth = ()=>{
        const data = firebaseAuthService()
        console.log( data)
    }
    ...
    return (
        <div className={styles.SocialAuth}>
            ...
            <Button className='ButtonFilledOval fillGoogle colorTextGrey1 buttonMaxWidth buttonMaxHeight' type='button' text='LOG IN WITH GOOGLE' icon={<GoogleIcon/>} onClick={()=>auth()}/>
